    ...
    messages: {
      pt: {
        ...
        faq: {
            ...
            a2: 'Atualmente, disponibilizamos templates para as seguintes especialidades: Cardiologia, Cardiologia Consulta Subsequente, Cardiooncologia, Cardiooncologia Consulta Subsequente, Cessação Tabágica, Cuidados Paliativos, Ecocardiografia, Junta Médica, MGF Adultos, MGF Crianças 0-2 anos, MGF Crianças 3-9 anos, MGF Crianças 10-18 anos, MGF Saúde Maternal, Notas de Alta, Notas de Alta Insuficiência Cardíaca, Notas de Alta Geral, Ortopedia Consulta Subsequente, Ortopedia Primeira Consulta, Pacemaker, Pedido de Referenciação, Pediatria 0-2 anos, Pediatria 3-9 anos, Pediatria 10-18 anos, Consulta de Pacing, Pedo Psicologia, Pedo Psicologia Consulta Subsequente, Pneumo Sono, Pneumologia Geral, Pneumologia Geral Consulta Subsequente, Radioncologia, Relatório Clínico, Ressonância Magnética. Estamos a trabalhar para adicionar mais especialidades no futuro.',
        ...
        stats: {
            ...
            experimentalTesting: 'médicos testaram a Medgical durante a fase experimental',
      ...
      en: {
        ...
        faq: {
            ...
            a2: 'Medgical can handle consultations from any specialty, including Cardiology, Cardiology Follow-up Consultation, Cardioncology, Cardioncology Follow-up Consultation, Smoking Cessation, Palliative Care, Echocardiography, Medical Board, Family Medicine Adults, Family Medicine Children: age 0-2, Family Medicine Children: age 3-9, Family Medicine Children: age 10-18, Family Medicine Maternal Health, Discharge Notes, Discharge Notes for Cardiac Insufficiency, General Discharge Notes, Orthopedics Follow-up Consultation, Orthopedics Initial Consultation, Pacemaker, Referral Request, Pediatrics: age 0-2, Pediatrics: age 3-9, Pediatrics: age 10-18, Pacing, Pediatric Psychology, Pediatric Psychology Follow-up Consultation, Sleep Pneumology, General Pulmonology, General Pulmonology Follow-up Consultation, Radiation Oncology, Clinical Report, Magnetic Resonance, and many more.',
        ...
        stats: {
            ...
            experimentalTesting: 'tester doctors tried Medgical during the experimental phase',
